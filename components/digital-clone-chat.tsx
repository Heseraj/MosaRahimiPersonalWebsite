  ...
  return (
    <div className="twin-chat">
      ...
      <div
        ...
        ref={messagesRef}
        aria-live="polite"
        aria-label="Digital Clone conversation"
      >
      ...
      <form className="twin-form" onSubmit={handleSubmit}>
        <label htmlFor="digital-clone-question" className="sr-only">
          Ask Mosa&apos;s Digital Clone a question
        </label>
        <textarea
          id="digital-clone-question"
          value={input}
